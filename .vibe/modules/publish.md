...
**Files:** `src/publish/validate-pack-file-list.ts`, `src/publish/verify-pack.mjs`, `src/publish/package-metadata.test.ts`, `src/publish/release-workflow.test.ts`, `smoke/package.json`, `smoke/index.html`, `smoke/main.js`
**Exports:** `validatePackFileList(files: readonly string[]): string | null`
